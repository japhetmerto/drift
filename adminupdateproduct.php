...
<br>
			 ...
			 <div class="col-sm-4">
				...
				<input type="number" class="form-control" id="price" required name="price" value="<?php echo $_SESSION["price"]; ?>" step="any">
				<div class="invalid-feedback">
			  ...
			  <div class="col-sm-4">
				...
				<input type="number" class="form-control" id="discount" name="discount_offer" value="<?php echo $_SESSION["discount_offer"]; ?>" step="any">
				<div class="invalid-feedback">
			  ...
			  <div class="col-sm-4">
				...
				<input type="number" onclick="getPrice()" class="form-control" id="total" name="discount_price" value="<?php echo $_SESSION["discount_price"]; ?>" step="any">
			  </div>
