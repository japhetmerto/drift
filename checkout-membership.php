  ...
  <body>
	...
	<div class="container text-white">
	  <div class="py-5 text-center">
		...
		<h2>Checkout form for <b class="text-warning">Membership</b></h2>
	  </div>
		...
		<div class="col-md-5 col-lg-4 order-md-last">
		  ...
		  <ul class="list-group mb-3">
			<li class="list-group-item d-flex justify-content-between lh-sm">
			  <div>
				<h6 class="my-0 text-dark"><?php echo "{$_GET['month']} Month(s) Of Membership"; ?></h6>
				<small class="text-muted">x1</small>
			  </div>
			  <span class="text-muted">RM <?php echo "{$_GET['price']}.00"; ?></span>
			</li>
			<li class="list-group-item d-flex justify-content-between bg-light">
			  <div class="text-success">
				<h6 class="my-0">Discount</h6>
			  </div>
			  <span class="text-success">RM 00.00</span>
			</li>
			<li class="list-group-item d-flex justify-content-between bg-light">
			  <div class="text-danger">
				<h6 class="my-0">Tax</h6>
			  </div>
			  <span class="text-danger">RM 00.00</span>
			</li>
			<li class="list-group-item d-flex justify-content-between bg-light">
			  <div class="text-danger">
			...
			<li class="list-group-item d-flex justify-content-between text-dark">
			  <span>Total (RM)</span>
			  <strong>RM <?php echo "{$_GET['price']}.00"; ?></strong>
			</li>
		  </ul>
		</div>
		<div class="col-md-7 col-lg-8">
		  <h4 class="mb-3 ">Billing <b class="text-warning">Address</b></h4>
		  <form class="needs-validation" novalidate action="assets/php/addmembership.php" method="post">
