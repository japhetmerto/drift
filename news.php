		...
		<main class="container">
		  <div class="row">
			...
			<aside class="col-md-4">
				<form class="input-group border-0 bg-transparent pb-3">
				  <input class="form-control" type="search" placeholder="Search" aria-label="Search">
				  <div class="input-group-append">
					<a href="search-result-news.html"class="btn btn-sm btn-warning text-secondary my-0 mx-0" type="submit" role="button">
					  <i class="fas fa-search mt-2"></i>
					</a>
				  </div>
				</form>
                  ...
                  <ul class="sidebar-nav-warning-hover list-unstyled mb-0 text-unset small-3 fw-600">
                    ...
                    <li class="nav-item text-light transition mb-2 active">
                      <a href="news.html" aria-expanded="false" class="nav-link py-2 px-3 text-uppercase nav-link-border">
                        <span class="p-collapsing-title text-white">All News</span>
                      </a>
					  <hr class="bg-white">
                    </li>
                    <li class="nav-item text-light transition mb-2">
                      <a href="news.html" aria-expanded="false" class="nav-link py-2 px-3 text-uppercase nav-link-border">
                        <span class="p-collapsing-title text-white">Announcements</span>
                      </a>
					  <hr class="bg-white">
                    </li>
                    <li class="nav-item text-light transition mb-2">
                      <a href="news.html" aria-expanded="false" class="nav-link py-2 px-3 text-uppercase nav-link-border">
                        <span class="p-collapsing-title text-white">Product Releases</span>
                      </a>
					  <hr class="bg-white">
                    </li>
                    <li class="nav-item text-light transition mb-2">
                      <a href="news.html" aria-expanded="false" class="nav-link py-2 px-3 text-uppercase nav-link-border">
                        <span class="p-collapsing-title text-white">Press Conferece</span>
                      </a>
					  <hr class="bg-white">
                    </li>
                  </ul>
