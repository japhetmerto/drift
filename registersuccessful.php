   ...
   <body style="background-image: url(assets/img/bg/bg-1.jpg);height: 100%;background-position: center;background-repeat: no-repeat;background-size: cover;">
	...
	<section >
		...
		<div class="container  w3-container w3-center w3-animate-opacity w3-animate-top">
		  <span class="login100-form--title p-b-41 text-white">Congratulations!</span>
		  <br><br>
		  <p style="color:white;">Your account has been registered successfully!<br>Sign in now to start shopping at Drift!</p>
